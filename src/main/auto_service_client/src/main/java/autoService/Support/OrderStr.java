...
public class OrderStr {
    ...
    public SimpleStringProperty getClientPhone()
    { 
        return new SimpleStringProperty(client.getString("phoneNumber"));
    }
    public SimpleStringProperty getClientFio()
    { 
        return new SimpleStringProperty(String.join(" ",client.getString("secondName"),client.getString("firstName"),client.getString("patronymic")));
    }
